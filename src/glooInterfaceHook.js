	...
	function iglooHookInterface() {
		this.run = function() {
			...
			if (mw.config.get('wgPageName') === glooPage) {
				...
				iglooLink.innerHTML = '<a id="igloo-goto-menu" target="_blank" href="'+serverBase+'WP:Igloo" title="igloo">igloo</a> | <a id="igloo-do-launch" style="font-color:red;" target="_blank" href="'+serverBase+glooPage+'" title="launch igloo">(launch)</a>';
